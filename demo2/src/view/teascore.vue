      ...
      <div class="right">
          ...
          <div class="list"> 
            ...
            <el-table :data="members"  stripe   height="550px">
              ...
              <el-table-column prop="title" label="作业题目" width="200"/>
...
export default {
  ...
  methods: {
    ...
    getscores(cflag){     
      this.$axios
        .get('api/tea/getscores?cflag='+cflag)
        .then(res => {
           this.members=res.data;
  ...
  mounted() {
       if (this.$route.params.cflag!=null) {   
        this.user.id=this.$route.params.cflag;
        this.getscores(this.$route.params.cflag);
