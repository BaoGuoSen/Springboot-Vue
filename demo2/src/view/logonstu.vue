...
<div  :style="note" class="login">
  ...
  <div class="divcenter">
    ...
    <div class="top">
        ...
        <h1 style="float:left;line-height:40px;">学生注册</h1>
    ...
    <div class="middle">
        ...
        <el-form ref="studentForm" :model="studentForm"  >
             ...
             <el-form-item >
                <el-input v-model="studentForm.id" style="width:300px;" placeholder="id"></el-input>
            </el-form-item>

            <el-form-item >
                <el-input v-model="studentForm.username" style="width:300px;" placeholder="用户名"></el-input>
            </el-form-item>
            
            <el-form-item >
                <el-input v-model="studentForm.password" style="width:300px;" placeholder="密码"></el-input>
            </el-form-item>

            <el-form-item>
                <el-button type="primary" @click="submit" style="width:300px;">注册为学生</el-button>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    addStudent() {
      this.$axios
        .post("api/logon/addStudent", this.studentForm)
        .then(res => {
          alert("添加成功");
          this.studentForm = {}
          this.jumpToList()
